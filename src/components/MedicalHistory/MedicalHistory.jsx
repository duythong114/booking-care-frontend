...
const MedicalHistory = () => {
  const totalHistoryPages = useSelector(
    (state) => state.booking.totalHistoryPages
  );
  const historyList = useSelector((state) => state.booking.historyList);
  const isGettingMedicalHistory = useSelector(
    (state) => state.booking.isGettingMedicalHistory
  );
